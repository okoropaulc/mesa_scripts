...
filt_en_afhi_2_mets <- filt_en_afhi_2_mets[,c(1,3)]
names(filt_en_afhi_2_mets) <- c("gene", "spearman")
write.table(filt_en_afhi_2_mets, file="Z:/data/ml_paper/afhi_2_mets_en_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afhi_2_mets_en <- mutate(filt_en_afhi_2_mets, model="EN",pop="AFHI")
...
filt_en_all_2_mets <- filt_en_all_2_mets[,c(1,3)]
names(filt_en_all_2_mets) <- c("gene", "spearman")
write.table(filt_en_all_2_mets, file="Z:/data/ml_paper/all_2_mets_en_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_en <- mutate(filt_en_all_2_mets, model="EN",pop="ALL")
...
filt_en_cau_2_mets <- filt_en_cau_2_mets[,c(1,3)]
names(filt_en_cau_2_mets) <- c("gene", "spearman")
write.table(filt_en_cau_2_mets, file="Z:/data/ml_paper/cau_2_mets_en_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_en <- mutate(filt_en_all_2_mets, model="EN",pop="CAU")
...
filt_en_his_2_mets <- filt_en_his_2_mets[,c(1,3)]
names(filt_en_his_2_mets) <- c("gene", "spearman")
write.table(filt_en_his_2_mets, file="Z:/data/ml_paper/his_2_mets_en_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_en <- mutate(filt_en_all_2_mets, model="EN",pop="HIS")
...
write.table(filt_en_afa_2_mets, file="Z:/data/ml_paper/afa_2_mets_en_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_en <- mutate(filt_en_all_2_mets, model="EN",pop="AFA")
...
write.table(filt_rf_afa_2_mets, file="Z:/data/ml_paper/afa_2_mets_rf_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afa_2_mets_rf <- mutate(filt_rf_afa_2_mets, model="RF",pop="AFA")
...
write.table(filt_rf_his_2_mets, file="Z:/data/ml_paper/his_2_mets_rf_rho_all.txt",
            row.names=F, sep="\t", quote=F)

his_2_mets_rf <- mutate(filt_rf_his_2_mets, model="RF",pop="HIS")
...
write.table(filt_rf_cau_2_mets, file="Z:/data/ml_paper/cau_2_mets_rf_rho_all.txt",
            row.names=F, sep="\t", quote=F)

cau_2_mets_rf <- mutate(filt_rf_cau_2_mets, model="RF",pop="CAU")
...
write.table(filt_rf_afhi_2_mets, file="Z:/data/ml_paper/afhi_2_mets_rf_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afhi_2_mets_rf <- mutate(filt_rf_afhi_2_mets, model="RF",pop="AFHI")
...
write.table(filt_rf_all_2_mets, file="Z:/data/ml_paper/all_2_mets_rf_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_rf <- mutate(filt_rf_all_2_mets, model="RF",pop="ALL")
...
write.table(filt_svr_afa_2_mets, file="Z:/data/ml_paper/afa_2_mets_svr_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afa_2_mets_svr <- mutate(filt_svr_afa_2_mets, model="SVR",pop="AFA")
...
write.table(filt_svr_his_2_mets, file="Z:/data/ml_paper/his_2_mets_svr_rho_all.txt",
            row.names=F, sep="\t", quote=F)

his_2_mets_svr <- mutate(filt_svr_his_2_mets, model="SVR",pop="his")
...
write.table(filt_svr_cau_2_mets, file="Z:/data/ml_paper/cau_2_mets_svr_rho_all.txt",
            row.names=F, sep="\t", quote=F)

cau_2_mets_svr <- mutate(filt_svr_cau_2_mets, model="SVR",pop="CAU")
...
write.table(filt_svr_afhi_2_mets, file="Z:/data/ml_paper/afhi_2_mets_svr_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afhi_2_mets_svr <- mutate(filt_svr_afhi_2_mets, model="SVR",pop="AFHI")
...
write.table(filt_svr_all_2_mets, file="Z:/data/ml_paper/all_2_mets_svr_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_svr <- mutate(filt_svr_all_2_mets, model="SVR",pop="ALL")
...
write.table(filt_knn_afa_2_mets, file="Z:/data/ml_paper/afa_2_mets_knn_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afa_2_mets_knn <- mutate(filt_knn_afa_2_mets, model="knn",pop="AFA")
...
write.table(filt_knn_his_2_mets, file="Z:/data/ml_paper/his_2_mets_knn_rho_all.txt",
            row.names=F, sep="\t", quote=F)

his_2_mets_knn <- mutate(filt_knn_his_2_mets, model="knn",pop="HIS")
...
write.table(filt_knn_cau_2_mets, file="Z:/data/ml_paper/cau_2_mets_knn_rho_all.txt",
            row.names=F, sep="\t", quote=F)

cau_2_mets_knn <- mutate(filt_knn_cau_2_mets, model="knn",pop="CAU")
...
write.table(filt_knn_afhi_2_mets, file="Z:/data/ml_paper/afhi_2_mets_knn_rho_all.txt",
            row.names=F, sep="\t", quote=F)

afhi_2_mets_knn <- mutate(filt_knn_afhi_2_mets, model="knn",pop="AFHI")
...
write.table(filt_knn_all_2_mets, file="Z:/data/ml_paper/all_2_mets_knn_rho_all.txt",
            row.names=F, sep="\t", quote=F)

all_2_mets_knn <- mutate(filt_knn_all_2_mets, model="knn",pop="ALL")
