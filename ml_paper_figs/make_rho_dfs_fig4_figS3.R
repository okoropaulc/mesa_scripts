...
afhi_2_mets_en <- subset(afhi_2_mets_en, spearman >0.1)
...
afhi_2_mets_rf <- subset(afhi_2_mets_rf, spearman >0.1)
...
afhi_2_mets_svr <- subset(afhi_2_mets_svr, spearman >0.1)
...
afhi_2_mets_knn <- subset(afhi_2_mets_knn, spearman >0.1)
...
all_2_mets_en <- subset(all_2_mets_en, spearman >0.1)
...
all_2_mets_rf <- subset(all_2_mets_rf, spearman >0.1)
...
all_2_mets_svr <- subset(all_2_mets_svr, spearman >0.1)
...
all_2_mets_knn <- subset(all_2_mets_knn, spearman >0.1)
...
cau_2_mets_en <- subset(cau_2_mets_en, spearman >0.1)
...
cau_2_mets_rf <- subset(cau_2_mets_rf, spearman >0.1)
...
cau_2_mets_svr <- subset(cau_2_mets_svr, spearman >0.1)
...
cau_2_mets_knn <- subset(cau_2_mets_knn, spearman >0.1)
...
his_2_mets_en <- subset(his_2_mets_en, spearman >0.1)
...
his_2_mets_rf <- subset(his_2_mets_rf, spearman >0.1)
...
his_2_mets_svr <- subset(his_2_mets_svr, spearman >0.1)
...
his_2_mets_knn <- subset(his_2_mets_knn, spearman >0.1)
...
afa_2_mets_en <- subset(afa_2_mets_en, spearman >0.1)
...
afa_2_mets_rf <- subset(afa_2_mets_rf, spearman >0.1)
...
afa_2_mets_svr <- subset(afa_2_mets_svr, spearman >0.1)
...
afa_2_mets_knn <- subset(afa_2_mets_knn, spearman >0.1)
