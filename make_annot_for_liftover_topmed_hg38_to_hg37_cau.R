...
topmed <- fread("/home/pokoro/data/mesa_models/topmed_dosages/CAU/chr" %&% j %&% "txt.gz", 
...
for (i in 1:nrow(topmed)){
  ...
  fwrite(snpannot, file="/home/pokoro/data/mesa_models/topmed_dosages/CAU/chr" %&% j %&% "_annot.txt", 
