...
ggplot(treedf, aes(x=trees, y=cvr2, fill=trees)) + geom_violin() + theme_classic(16) + ylim(-1,1) +
  ggtitle("Random Forest Trees Performance") + ylab(expression(paste("Cross-Validated ", R^{2}))) + 
  xlab("Number of Trees") + theme(legend.position = "none") + geom_boxplot(width=0.15)
